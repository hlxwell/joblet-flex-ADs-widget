package item
{
	...
	public class VerticalItem extends VBox
	{
		...
		private function init():void {
			...
			this.addChild(jobImage);
			this.addChild(jobTitle);
			this.addChild(jobSalary);
			this.addChild(jobCompany);
			this.addChild(hrule);
		}
